...
This script will delete all signals, signal performance, and backtest data
"""
...
async def main():
    """Main function"""
    print("⚠️  WARNING: This will delete ALL trading data from the database!")
    print("This includes:")
    print("- All signals")
